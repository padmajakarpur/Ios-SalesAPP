...
@interface MyRefrencesViewController ()

@end

@implementation MyRefrencesViewController
...
- (void)viewDidLoad {
    ...
    horizontallbl.text=@"MY REFERENCES";
    [horizontallbl setTextColor:[UIColor whiteColor]];
    horizontallbl.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:horizontallbl];
    
    stattusarr=[[NSMutableArray alloc]initWithObjects:@"SITE VISIT CONDUCTED",@"FOLLOW UP",@"SITE VISIT CONDUCTED",@"NOT REACHABLE",@"BOOKED", nil];
    tableViewHome = [[UITableView alloc] init];
    [tableViewHome setFrame:CGRectMake(screenRect.size.width*0.03,screenRect.size.height*.24, screenRect.size.width*.94,screenRect.size.height*.60)];
   ...
   tableViewHome.separatorStyle=UITableViewCellSeparatorStyleNone;
    ...
    UIView *coldview = [[UIView alloc] initWithFrame:CGRectMake(screenRect.size.width*0.40,screenRect.size.height*0.88,screenRect.size.width*0.04,screenRect.size.height*0.02)];
    coldview.backgroundColor=[UIColor colorWithHexString:@"#00bfff"];
    [self.view addSubview:coldview];
    
    UILabel*  coldlbl = [[UILabel alloc] initWithFrame:CGRectMake(screenRect.size.width*0.44,screenRect.size.height*0.87,screenRect.size.width*0.10,screenRect.size.height*0.04)];
    coldlbl.font=[UIFont systemFontOfSize:screenRect.size.width*0.025];
    coldlbl.textAlignment = NSTextAlignmentCenter;
    coldlbl.text = @"COLD";
    coldlbl.backgroundColor = [UIColor clearColor];
    coldlbl.textColor=[UIColor whiteColor];
    [self.view addSubview:coldlbl];
    
    UIView *warmview = [[UIView alloc] initWithFrame:CGRectMake(screenRect.size.width*0.54,screenRect.size.height*0.88,screenRect.size.width*0.04,screenRect.size.height*0.02)];
    warmview.backgroundColor=[UIColor colorWithHexString:@"#ffff00"];
    [self.view addSubview:warmview];
    
    UILabel*  warmlbl = [[UILabel alloc] initWithFrame:CGRectMake(screenRect.size.width*0.58,screenRect.size.height*0.87,screenRect.size.width*0.10,screenRect.size.height*0.04)];
    warmlbl.font=[UIFont systemFontOfSize:screenRect.size.width*0.025];
    warmlbl.textAlignment = NSTextAlignmentCenter;
    warmlbl.text = @"WARM";
    warmlbl.backgroundColor = [UIColor clearColor];
    warmlbl.textColor=[UIColor whiteColor];
    [self.view addSubview:warmlbl];
    
    UIView *hotview = [[UIView alloc] initWithFrame:CGRectMake(screenRect.size.width*0.68,screenRect.size.height*0.88,screenRect.size.width*0.04,screenRect.size.height*0.02)];
    hotview.backgroundColor=[UIColor colorWithHexString:@"#ff1919"];
    [self.view addSubview:hotview];
    
    UILabel*  hotlbl = [[UILabel alloc] initWithFrame:CGRectMake(screenRect.size.width*0.72,screenRect.size.height*0.87,screenRect.size.width*0.10,screenRect.size.height*0.04)];
    hotlbl.font=[UIFont systemFontOfSize:screenRect.size.width*0.025];
    hotlbl.textAlignment = NSTextAlignmentCenter;
    hotlbl.text = @"HOT";
    hotlbl.backgroundColor = [UIColor clearColor];
    hotlbl.textColor=[UIColor whiteColor];
    [self.view addSubview:hotlbl];
    
    UIView *bookinview = [[UIView alloc] initWithFrame:CGRectMake(screenRect.size.width*0.82,screenRect.size.height*0.88,screenRect.size.width*0.04,screenRect.size.height*0.02)];
    bookinview.backgroundColor=[UIColor colorWithHexString:@"#00cc00"];
    [self.view addSubview:bookinview];
    
    UILabel*  bookinglbl = [[UILabel alloc] initWithFrame:CGRectMake(screenRect.size.width*0.86,screenRect.size.height*0.87,screenRect.size.width*0.12,screenRect.size.height*0.04)];
    bookinglbl.font=[UIFont systemFontOfSize:screenRect.size.width*0.025];
    bookinglbl.textAlignment = NSTextAlignmentCenter;
    bookinglbl.text = @"BOOKING";
    bookinglbl.backgroundColor = [UIColor clearColor];
    bookinglbl.textColor=[UIColor whiteColor];
    [self.view addSubview:bookinglbl];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIView *leftview = [[UIView alloc] initWithFrame:CGRectMake(screenRect.size.width*0.0,0,screenRect.size.width*0.07,screenRect.size.height*0.12)];
    
    UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake(screenRect.size.width*0.07,0,screenRect.size.width*0.87,screenRect.size.height*0.12)];
    headerView.backgroundColor=[UIColor whiteColor];
    
    UILabel*  Srnolbl = [[UILabel alloc] initWithFrame:CGRectMake(screenRect.size.width*0.02,0,screenRect.size.width*0.40,screenRect.size.height*0.04)];
    Srnolbl.font=[UIFont boldSystemFontOfSize:screenRect.size.width*0.04];
    Srnolbl.textAlignment = NSTextAlignmentLeft;
    Srnolbl.text =@"YYGV HUV";
    ...
    UIButton *Createvoucherbtn=[[UIButton alloc]initWithFrame:CGRectMake(screenRect.size.width*0.52,screenRect.size.height*0.08,screenRect.size.width*0.32,screenRect.size.height*0.03)];
   ...
   // [Createvoucherbtn addTarget:self action:@selector(login) forControlEvents:UIControlEventTouchUpInside];
    ...
    if ([[stattusarr objectAtIndex:indexPath.row] isEqualToString:@"SITE VISIT CONDUCTED"]) {
        [Createvoucherbtn setBackgroundColor:[UIColor colorWithHexString:@"#ff1919"]] ;
        leftview.backgroundColor=[UIColor colorWithHexString:@"#ff1919"];
    }
    if ([[stattusarr objectAtIndex:indexPath.row] isEqualToString:@"FOLLOW UP"]) {
        [Createvoucherbtn setBackgroundColor:[UIColor colorWithHexString:@"#ffff00"]] ;
        leftview.backgroundColor=[UIColor colorWithHexString:@"#ffff00"];
        [Createvoucherbtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        
    }
    if ([[stattusarr objectAtIndex:indexPath.row] isEqualToString:@"NOT REACHABLE"]) {
        [Createvoucherbtn setBackgroundColor:[UIColor colorWithHexString:@"#00bfff"]] ;
        leftview.backgroundColor=[UIColor colorWithHexString:@"#00bfff"];
    }
...
{
    CGRect screenRect = [[UIScreen mainScreen] bounds];
    return screenRect.size.height*0.13;
}
