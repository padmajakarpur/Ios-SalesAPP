...
//    headerarr=[NSMutableArray arrayWithObjects:@"Project Mobile",@"No of visit",@"Prospect Stage",@"Remark",@"Subject",@"Task",@"Assigned To",@"Prospect Source", @"Prospect source", @"Assigned To", @"Address", @"Street", @"City",@"State", @"Postal Code", @"Country", @"Sales Action",@"Location Preference",@"Other Project Of Interest",@"Schedule On", nil];
//
//   tittletxtarr=[NSMutableArray arrayWithObjects:[dict objectForKey:@"project_name"],[dict objectForKey:@"phone_mobile"],[dict objectForKey:@"phone_office"],[dict objectForKey:@"phone_home"],[dict objectForKey:@"email_address"],@"alt email", [dict objectForKey:@"leadStatus"],[dict objectForKey:@"lead_stage_c"],@"",@"",@"Sales_xrbia 1",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"l",nil];
//
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView.tag==0) {
        ...
        textlbl.text =[tittletxtarr objectAtIndex:indexPath.row];
