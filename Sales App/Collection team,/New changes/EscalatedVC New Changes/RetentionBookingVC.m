//
//  RetentionBookingVC.m
//  Sales App
//
//  Created by Infinitum on 16/04/19.
...
@implementation RetentionBookingVC
@synthesize comestr,tableViewHome,TakePhotoView,indicator,segmentedControl,teamtableview,bookingarr,demoView,remarktxt;
...
- (void)viewDidLoad {
    ...
    horizontallbl.text=@"Retention Booking";
